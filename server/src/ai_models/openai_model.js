...
export const openai_image = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    //  Upload to Cloudinary under Morphix/GPT5
    const cloudinaryUrl = await uploadToCloudinary(imageBase64, "GPT5");
